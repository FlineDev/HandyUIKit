...
extension UIColor {
    ...
    public func change(_ attribute: ChangeableAttribute, by addition: CGFloat) -> UIColor {
        ...
        case .alpha:        return change(attribute, to: rgba.alpha + addition)
        case .hue:          return change(attribute, to: hsba.hue + addition)
    ...
    public func change(_ attribute: ChangeableAttribute, to newValue: CGFloat) -> UIColor {
        ...
        case .red, .green, .blue, .alpha:
            ...
            case .alpha:        newRgba.alpha = newValue
            default: break
            }
